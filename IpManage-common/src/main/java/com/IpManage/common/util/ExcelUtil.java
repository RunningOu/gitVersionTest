...
import com.IpManage.common.util.poi.*;


import com.IpManage.dataobject.Excel;
...
public class ExcelUtil<T>
{
     ...
     * @return 结果
     */
    public BaseResult importTemplateExcel(String sheetName, HttpServletResponse response)
    {
    ...
    public BaseResult exportExcel(HttpServletResponse response)
    {
        ...
        try
        {
            ...
            log.info("文件：{}",getAbsoluteFile(filename));*/
            wb.write(out);
            return BaseResultGenerator.success(filename);
        }
        catch (Exception e)
        {
