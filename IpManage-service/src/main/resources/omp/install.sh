...
sh -c "sed -i 's@JAVA_OPTS=.*@JAVA_OPTS=$JAVA_OPTS@' IpManage-service.sh"
...
chown -R $RUNNING_USER:$RUNNING_USER /opt/uyun/IpManage/service
chmod 750 /opt/uyun/IpManage/service
...
setPer '/opt/uyun/IpManage/service'
#chmod 750 /opt/uyun/IpManage/service

su $RUNNING_USER -c "/opt/uyun/IpManage/service/bin/IpManage-service.sh start"
echo "ready to start IpManage-service"
check_stat IpManage-service 65521
echo "IpManage-service start!"
