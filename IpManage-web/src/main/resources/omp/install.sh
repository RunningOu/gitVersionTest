...
sh -c "sed -i 's@JAVA_OPTS=.*@JAVA_OPTS=$JAVA_OPTS@' IpManage-web.sh"
...
chown -R $RUNNING_USER:$RUNNING_USER /opt/uyun/IpManage/web
chmod 750 /opt/uyun/IpManage/web
...
setPer '/opt/uyun/IpManage/web'
#chmod 750 /opt/uyun/IpManage/web

su $RUNNING_USER -c "/opt/uyun/IpManage/web/bin/IpManage-web.sh start"
echo "ready to start IpManage-web"
check_stat IpManage-web 65520
echo "IpManage-web start!"
